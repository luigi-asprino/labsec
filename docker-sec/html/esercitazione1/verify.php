...
define("CSSREF",        "./esercitazione01/css/labsic.css");
define("WP_CACHE_BASE", "cache/");
define("LOGOREF",       "./esercitazione01/img/logo.gif");
define("STARTPAGEREF",  "./esercitazione01/index.php");
define("DEBUG", FALSE);
...
function build_mail_body($WP_CACHE, $param_email, $param_fullname, $param_number, $param_inputfile, $param_digest, $param_pkey, $boundary) {
...
if (!(validate_param_email($param_email))) {
        ...
        if ($userdigest === FALSE) {
          ...
          if ($adjusted === FALSE) {
            ...
            if ($c_ret !== 0) {
             ...
             $studentAddress = trim($param_email);
             $boundary = md5(uniqid(microtime()));
             $labsicurezzaAddress = "labsicurezza@cs.unibo.it";
			 $from = $studentAddress;
			 $to = $studentAddress . ", " . $labsicurezzaAddress;
			 $subject = "[Laboratorio Sicurezza $AA: Esercitazione 01]: " . trim($param_fullname) . " " . trim($param_number);
			 $mail_body = build_mail_body($WP_CACHE, $param_email, $param_fullname, $param_number, $param_inputfile, $param_digest, $param_pkey, $boundary);
